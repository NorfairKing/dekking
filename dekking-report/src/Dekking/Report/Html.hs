...
module Dekking.Report.Html
  ( CoverageReport (..),
    ...
    coverageSummaryTotal,
    htmlCoverageReport,
    htmlPackageCoverageReport,
    htmlModuleCoverageReport,
    coverageReportCss,
    coverageReportJS,
    ReportFile (..),
    renderReportFile,
...
renderReportFile = \case
  ...
  UncoveredJSONFile -> "uncovered.json"
  UncoveredTextFile -> "uncovered.txt"
  StyleFile -> "style.css"
